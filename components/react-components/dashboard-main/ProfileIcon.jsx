...
const ProfileIcon = ({ profileData, setLoading }) => {
	...
	return (
		...
		>
			...
			{/* <div className="m-3">
				<div
					className={`row row-cols-2 watch-profile-transform ${
						!profileHover ? "opacity-0" : "opacity-100"
					}`}
				>
					<div className="col">
						<button className="btn btn-outline-secondary btn-circle">
							<svg
					...
					<div className="col">
						<button
							className="col btn btn-outline-danger btn-circle"
